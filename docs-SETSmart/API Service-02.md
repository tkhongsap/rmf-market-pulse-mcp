...
## Get Stock Quote all Symbols

EOD stock price (both original price and adjusted price are available) and statistics such as P/E and dividend yield of all symbols per day. Period of historical data is available according to your SETSMART package.
...
```
https://www.setsmart.com/api/listed-company-api/eod-price-by-security-type
```
...
<table>
  ...
  <tbody>
    <tr>
      <td>securityType<br>(query)</td>
<td>string • required</td>
<td>
        Security Type<br>
        - All = All security types<br>
        - CS = Common Stock<br>
...
<table>
    ...
    <tr>
        <td>date</td>
        <td colspan="2">string Trading date</td>
    </tr>
<tr>
        <td>symbol</td>
