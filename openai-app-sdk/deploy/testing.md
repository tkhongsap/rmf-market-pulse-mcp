...
Testing validates that your connector behaves predictably before launching to users. Focus on three areas: tool correctness, component UX, and discovery precision.

## Unit Test Your Tool Handlers

- Exercise each tool function directly with representative inputs
- Verify schema validation, error handling, and edge cases (empty results, missing IDs)
