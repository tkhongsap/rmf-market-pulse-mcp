...
1. Writing action-oriented tool descriptions ("Use this when the user wants to view their kanban board") rather than generic copy.
2. Writing clear component descriptions on the resource UI template metadata.
